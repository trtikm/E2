#ifndef AIOLD_OBJECT_ID_HPP_INCLUDED
#   define AIOLD_OBJECT_ID_HPP_INCLUDED
...
template<>
struct hash<aiold::object_id>
{
    size_t operator()(aiold::object_id const&  id) const
    {
        std::size_t seed = 0;
        ::hash_combine(seed, aiold::as_number(id.kind));
