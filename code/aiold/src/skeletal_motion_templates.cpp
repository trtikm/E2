            ...
            else
            {
                ...
                if (boost::filesystem::is_directory(entry_pathname / "!meta"))
                {
                    ...
                    if (record.reference_frames.empty() && boost::filesystem::is_regular_file(meta_pathname / "reference_frames.txt"))
                        record.reference_frames = motion_template::reference_frames_type(meta_pathname / "reference_frames.txt", 1U, ultimate_finaliser, "aiold::skeletal_motion_templates_data::reference_frames");
