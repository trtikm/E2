...
static natural_32_bit num_bytes_to_store_bits(natural_32_bit const num_bits_to_store)
{
...
dynamic_state_of_neural_tissue::dynamic_state_of_neural_tissue(
    ...
    , m_num_synapses_in_all_cell_territories_along_columnar_axis(
            [](std::shared_ptr<static_state_of_neural_tissue const> const tissue_props) {
                natural_32_bit num_sysnapses_in_column = 0;
                for (natural_8_bit kind = 0; kind < tissue_props->num_kinds_of_cells_in_neural_tissue(); ++kind)
                    num_sysnapses_in_column +=
                        tissue_props->num_tissue_cells_in_column(kind)
                        * tissue_props->get_static_state_of_tissue_cell(kind)
        ...
        )
{
    ...
    natural_32_bit const seek_to_column_with_synaptic_of_territory =
            seek_along_y_axis
                * m_static_state_of_neural_tissue->num_tissue_cells_along_x_axis()
                * m_num_synapses_in_all_cell_territories_along_columnar_axis
            + seek_along_x_axis
    ...
    natural_32_bit seek_in_column_to_sysnapses_of_territory = 0;
    natural_8_bit cell_kind_of_territory = 0;
    {
    ...
    natural_32_bit const first_bit_of_first_synapse_in_territory =
