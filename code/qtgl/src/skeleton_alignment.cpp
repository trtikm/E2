...
skeleton_alignment_data::skeleton_alignment_data(async::finalise_load_on_destroy_ptr const  finaliser)
    : m_skeleton_alignment()
    , m_skeleton_alignment_path(finaliser->get_key().get_unique_id())
{
    TMPROF_BLOCK();
