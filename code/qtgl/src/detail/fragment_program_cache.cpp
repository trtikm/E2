...
void  fragment_program_cache::cached(std::vector< std::pair<boost::filesystem::path,fragment_program_properties_ptr> >&  output)
{
    TMPROF_BLOCK();
...
void  fragment_program_cache::failed(std::vector< std::pair<boost::filesystem::path,std::string> >&  output)
{
    TMPROF_BLOCK();
