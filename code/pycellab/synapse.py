...
def __test_synapse():
    ...
    for the_synapse in [
            synapse.plastic_peek_np(),
            synapse.plastic_peek_pn(),
            synapse.plastic_peek_pp(),
            synapse.plastic_peek_nn(),
            ]:
        ...
        output_dir = os.path.join(config.__output_root_dir(), "__test_synapse", the_synapse.get_name())
