#ifndef E2_EXPERIMENTS_NETLAB_CORTEX_FUNCTIONS_PROGRAM_OPTIONS_HPP_INCLUDED
#   define E2_EXPERIMENTS_NETLAB_CORTEX_FUNCTIONS_PROGRAM_OPTIONS_HPP_INCLUDED
...
public:
    ...
    std::string  experiment() const { return vm["exp"].as<std::string>(); }
