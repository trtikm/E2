...
struct  simulator : public osi::simulator
{
    struct  render_configuration
    {
        ...
        //                 Feel free to modify these field, ideally in the callback 'on_begin_render()'
        ...
        //                        They are reset in the next round. Perform your changes in the callback 'on_begin_render()'.
