            ...
            }
{
    ...
    QVBoxLayout* const dlg_layout = new QVBoxLayout;
    {
        ...
        QVBoxLayout* const effects_layout = new QVBoxLayout;
        {
            ...
            effects_layout->addWidget(light_types_group);

            QWidget* const light_data_types_group = new QGroupBox("Light data locations");
            {
            ...
            effects_layout->addWidget(light_data_types_group);


            effects_layout->addWidget(new QLabel("TODO!"));
        ...
        QWidget* const note_group = new QGroupBox();
        {
            QVBoxLayout* const note_layout = new QVBoxLayout;
            {
                note_layout->addWidget(new QLabel(
                    "NOTE: Not all commbinations of values in this dialog\n"
                    "are supported. Therefore, the combination you set here\n"
                    "is only used as a search key to a dictionary of supported\n"
                    "combinations - the closest supported combination to yours\n"
                    "it then actually used."
                    ));
            }
