...
public slots:
    ...
    void  on_draw_show_ai_action_control_changed(int const  value) { m_tab_draw_widgets.on_show_ai_action_control_changed(value); }
    ...
    void  scene_listener_simulation_resumed() { m_tab_scene_widgets.on_simulation_resumed(); m_status_bar.camera_controller_changed_listener(); }
    ...
    void  on_menu_edit_agent_reset_skeleton_pose() { m_tab_scene_widgets.on_scene_agent_reset_skeleton_pose(); }
