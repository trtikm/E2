...
namespace netexp { namespace dbg_spiking_develop {
...
void __register__(netexp::experiment_factory&  factory)
{
    factory.register_experiment(
            "dbg_spiking_develop",
            netexp::dbg_spiking_develop::create_network,
            netexp::dbg_spiking_develop::create_tracked_spiker_stats,
            netexp::dbg_spiking_develop::create_tracked_dock_stats,
            netexp::dbg_spiking_develop::create_tracked_ship_stats,
