...
void  spread_synapses_into_neighbourhoods(
        ...
        std::vector<natural_32_bit> const&  matrix_of_counts_of_synapses_to_be_spread_into_columns_in_neighbourhood,
                //!< A matrix of diameter_x rows and diameter_y columns. Row-axis is aligmend with x-axis of the
                //!< neural tissue. The matrix is stored in the vector in the column-major order.
