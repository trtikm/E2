...
std::string  name(VERTEX_SHADER_INPUT_BUFFER_BINDING_LOCATION const  location)
{
    ...
    case VERTEX_SHADER_INPUT_BUFFER_BINDING_LOCATION::BINDING_IN_INSTANCED_MATRIX_FROM_MODEL_TO_CAMERA: return "BINDING_IN_INSTANCED_MATRIX_FROM_MODEL_TO_CAMERA";
    case VERTEX_SHADER_INPUT_BUFFER_BINDING_LOCATION::BINDING_IN_INSTANCED_DIFFUSE_COLOUR: return "BINDING_IN_INSTANCED_DIFFUSE_COLOUR";
    default: UNREACHABLE();
    }
}
...
std::string  type_name(VERTEX_SHADER_INPUT_BUFFER_BINDING_LOCATION const  location)
{
    ...
    case VERTEX_SHADER_INPUT_BUFFER_BINDING_LOCATION::BINDING_IN_INSTANCED_MATRIX_FROM_MODEL_TO_CAMERA: return "mat4";
    case VERTEX_SHADER_INPUT_BUFFER_BINDING_LOCATION::BINDING_IN_INSTANCED_DIFFUSE_COLOUR: return "vec4";
    default: UNREACHABLE();
    }
}
