...
layer_index_type  compressed_layer_and_object_indices::layer_index() const noexcept
{
    return static_cast<layer_index_type>(m_compressed_indices >> detail::shift_for_layer());
}

object_index_type  compressed_layer_and_object_indices::object_index() const noexcept
{
